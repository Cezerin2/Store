...
class CheckoutStepContacts extends React.Component {
  ...
  render() {
    ...
    if (isReadOnly) {
      ...
      }, /*#__PURE__*/React.createElement("h1", null, /*#__PURE__*/React.createElement("span", null, "1"), title), !this.isFieldHidden("first_name") && /*#__PURE__*/React.createElement(ReadOnlyField, {
        name: text.first_name,
        value: initialValues.first_name
      }), !this.isFieldHidden("last_name") && /*#__PURE__*/React.createElement(ReadOnlyField, {
        name: text.last_name,
        value: initialValues.last_name
      }), !this.isFieldHidden("email") && /*#__PURE__*/React.createElement(ReadOnlyField, {
        name: text.email,
        value: initialValues.email
      }), !this.isFieldHidden("mobile") && /*#__PURE__*/React.createElement(ReadOnlyField, {
        name: text.mobile,
        value: initialValues.mobile
      }), !this.isFieldHidden("address1") && /*#__PURE__*/React.createElement(ReadOnlyField, {
        name: text.address1,
        value: initialValues.shipping_address.address1
      }), !this.isFieldHidden("address2") && /*#__PURE__*/React.createElement(ReadOnlyField, {
        name: text.address2,
        value: initialValues.shipping_address.address2
      }), !this.isFieldHidden("country") && /*#__PURE__*/React.createElement(ReadOnlyField, {
        name: text.country,
        value: initialValues.shipping_address.country
      }), !this.isFieldHidden("state") && /*#__PURE__*/React.createElement(ReadOnlyField, {
        name: text.state,
        value: initialValues.shipping_address.state
      }), !this.isFieldHidden("postal_code") && /*#__PURE__*/React.createElement(ReadOnlyField, {
        name: text.postal_code,
        value: initialValues.shipping_address.postal_code
      }), !this.isFieldHidden("city") && /*#__PURE__*/React.createElement(ReadOnlyField, {
        name: text.city,
      ...
      }, text.edit)), /*#__PURE__*/React.createElement("h2", null, text.shippingMethods, " ", loadingShippingMethods && /*#__PURE__*/React.createElement("small", null, text.loading)), /*#__PURE__*/React.createElement("div", {
        className: "shipping-methods"
      }, shippingMethods.map((method, index) => /*#__PURE__*/React.createElement("label", {
        key: index,
      ...
      }, method.description)), /*#__PURE__*/React.createElement("span", {
        className: "shipping-method-rate"
      }, formatCurrency(method.price, settings))))), /*#__PURE__*/React.createElement("h2", null, text.paymentMethods, " ", loadingPaymentMethods && /*#__PURE__*/React.createElement("small", null, text.loading)), /*#__PURE__*/React.createElement("div", {
        className: "payment-methods"
      }, paymentMethods.map((method, index) => /*#__PURE__*/React.createElement("label", {
        key: index,
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "checkout-step"
    }, /*#__PURE__*/React.createElement("h1", null, /*#__PURE__*/React.createElement("span", null, "1"), title), /*#__PURE__*/React.createElement("form", {
      onSubmit: handleSubmit
    }, !this.isFieldHidden("first_name") && /*#__PURE__*/React.createElement(Field, {
    ...
    }), !this.isFieldHidden("last_name") && /*#__PURE__*/React.createElement(Field, {
      className: inputClassName,
      name: "last_name",
    ...
    }), this.state.loggedin ? /*#__PURE__*/React.createElement(ReadOnlyField, {
      name: text.email,
      value: this.state.emailValues,
      className: "logged-in-email-field",
      label: this.getFieldLabel("email")
    }) : !this.isFieldHidden("email") && /*#__PURE__*/React.createElement(Field, {
      className: inputClassName,
      name: "email",
      id: "customer.email",
      autoComplete: "new-password",
    ...
    }), !this.isFieldHidden("mobile") && /*#__PURE__*/React.createElement(Field, {
      className: inputClassName,
      name: "mobile",
      id: "customer.mobile",
      autocomplete: "new-password",
    ...
    }), this.state.loggedin ? this.isFieldHidden("password") : !this.isFieldHidden("password") && /*#__PURE__*/React.createElement(Field, {
      className: inputClassName,
      name: "password",
    ...
    }), !this.isFieldHidden("address1") && /*#__PURE__*/React.createElement(Field, {
      className: inputClassName,
      ...
      onBlur: (event, value) => setTimeout(() => saveShippingLocation({
        address1: value
      }))
    }), !this.isFieldHidden("address2") && /*#__PURE__*/React.createElement(Field, {
      className: inputClassName,
    ...
    }), !this.isFieldHidden("country") && /*#__PURE__*/React.createElement(Field, {
      className: inputClassName,
    ...
    }), !this.isFieldHidden("state") && /*#__PURE__*/React.createElement(Field, {
      className: inputClassName,
    ...
    }), !this.isFieldHidden("postal_code") && /*#__PURE__*/React.createElement(Field, {
      className: inputClassName,
    ...
    }), !this.isFieldHidden("city") && /*#__PURE__*/React.createElement(Field, {
      className: inputClassName,
